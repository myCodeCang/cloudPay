...
<body>
	...
	<form:form id="inputForm" modelAttribute="userUserinfo" action="${ctx}/user/userUserinfo/save" method="post" class="form-horizontal">
		...
		<%--<div class="control-group">--%>
			...
			<%--<div class="controls">--%>
				<%--<input name="zhuanquPass" htmlEscape="false" maxlength="60" class="input-xlarge " type="password"/>--%>
				<%--<span class="help-inline"><font color="red">*</font></span>--%>
			<%--</div>--%>
		<%--</div>--%>
		<div class="control-group">
			...
			<div class="controls">
				<input name="LevelName" htmlEscape="false" maxlength="60" class="input-xlarge " value="${userUserinfo.userLevel.levelName}" type="text" readonly/>
				<span class="help-inline"><font color="red">*</font></span>
			</div>
			<%--<div class="controls">--%>
