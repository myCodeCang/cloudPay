...
<body>
	...
	<form:form id="inputForm" modelAttribute="userLevel" action="${ctx}/user/userLevel/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">消费提成：</label>
			<div class="controls">
		...
		<div class="control-group">
		<label class="control-label">推广收益：</label>
		<div class="controls">
		...
		<%--<div class="control-group">--%>
			<%--<label class="control-label">下级消费提成：</label>--%>
			<%--<div class="controls">--%>
		...
		<%--</div>--%>
		<div class="control-group">
			<label class="control-label">升级金额：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label">赠送丝路：</label>
			<div class="controls">
				<form:input path="staticMoneyHigh" htmlEscape="false" maxlength="8" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
