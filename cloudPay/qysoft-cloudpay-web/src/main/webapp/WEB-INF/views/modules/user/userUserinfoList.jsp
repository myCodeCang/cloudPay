	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="userUserinfo">
			<tr>
				...
				<td>
						${userUserinfo.addressArea}
				</td>
				<td>
						${fns:getDictLabel(userUserinfo.activeStatus, 'yes_no', '')}
				</td>
				<td>
					${userUserinfo.area.name}
				</td>
				<td>
						${userUserinfo.area.type == '1'?"国级代理":userUserinfo.area.type == '2'?"省级代理":userUserinfo.area.type == '3'?"市级代理":userUserinfo.area.type == '4'?"区县级代理":"不是代理"}
				</td>
				<td>
						${fns:getDictLabel(userUserinfo.isShop, 'yes_no', '')}
				</td>
				<%--<td>--%>
