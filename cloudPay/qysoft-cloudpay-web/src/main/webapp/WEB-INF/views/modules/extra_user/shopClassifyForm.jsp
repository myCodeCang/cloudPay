...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/extra_user/shopClassify/">分类列表</a></li>
		<li class="active"><a href="${ctx}/extra_user/shopClassify/form?id=${shopClassify.id}">分类<shiro:hasPermission name="extra_user:shopClassify:edit">${not empty shopClassify.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="extra_user:shopClassify:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="shopClassify" action="${ctx}/extra_user/shopClassify/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
