...
<form:form id="searchForm" modelAttribute="userReport"
		   action="${ctx}/user/yzfReport/yzfReportView/" method="post"
...
<div class="bochu">
	<ul>
		<%--<li>--%>
			<%--<div>--%>
				<%--<div><span>平台拨出率:</span>&nbsp;<span>${yzfReport.dividendEight==null ? '--' : yzfReport.dividendEight}</span></div>--%>
				<%--<p>根据所选择的时间范围计算出的平台拨出率 [总支出 / 总收入]</p>--%>
			<%--</div>--%>
		<%--</li>--%>
		<%--<li>--%>
			<%--<div>--%>
				<%--<div><span>总收入:</span>&nbsp;<span>${yzfReport.dividendSeven==null ? '--' : yzfReport.dividendSeven}</span></div>--%>
				<%--<p>根据所选择的时间范围计算出的总收入</p>--%>
			<%--</div>--%>
		<%--</li>--%>
		<%--<li>--%>
			<%--<div>--%>
				<%--<div><span>总支出:</span>&nbsp;<span>${yzfReport.dividendSix==null ? '--' : yzfReport.dividendSix}</span></div>--%>
				<%--<p>根据所选择的时间范围计算出的总支出</p>--%>
			<%--</div>--%>
		<%--</li>--%>
		<%--<li>--%>
			<%--<div>--%>
				<%--<div><span>钱包余额:</span>&nbsp;<span>${yzfReport.dividendThree==null ? '--' : yzfReport.dividendThree}</span></div>--%>
				<%--<p>根据所选择的时间范围计算出的总首奖</p>--%>
			<%--</div>--%>
		<%--</li>--%>
		<li>
			<div>
				<div><span>充值:</span>&nbsp;<span>${yzfReport.dividendFour==null ? '--' : yzfReport.dividendFour}</span></div>
				<p>根据所选择的时间范围计算出的充值总额</p>
			</div>
		</li>
		<li>
			<div>
				<div><span>提现:</span>&nbsp;<span>${yzfReport.dividendFive==null ? '--' : yzfReport.dividendFive}</span></div>
				<p>根据所选择的时间范围计算出的提现总额</p>
			</div>
		</li>
		<li>
			<div>
				<div><span>丝路释放:</span>&nbsp;<span>${yzfReport.dividendOne==null ? '--' : yzfReport.dividendOne}</span></div>
				<p>根据所选择的时间范围计算出的丝路释放</p>
			</div>
		</li>
		<li>
			<div>
				<div><span>转账:</span>&nbsp;<span>${yzfReport.dividendSeven==null ? '--' : yzfReport.dividendSeven}</span></div>
				<p>根据所选择的时间范围计算出的总转账</p>
			</div>
		</li>
		<li>
			<div>
				<div><span>消费:</span>&nbsp;<span>${yzfReport.dividendEight==null ? '--' : yzfReport.dividendEight}</span></div>
				<p>根据所选择的时间范围计算出的总消费</p>
			</div>
		</li>
		<li>
			<div>
			<div><span>升级:</span>&nbsp;<span>${yzfReport.dividendSix==null ? '--' : yzfReport.dividendSix}</span></div>
			<p>根据所选择的时间范围计算出的升级</p>
			</div>
		</li>
		<li>
			<div>
				<div><span>直属推广奖:</span>&nbsp;<span>${yzfReport.dividendTwo==null ? '--' : yzfReport.dividendTwo}</span></div>
				<p>根据所选择的时间范围计算出的直属推广奖</p>
			</div>
		</li>
		<%--<li>--%>
			<%--<div>--%>
				<%--<div><span>代理收益:</span>&nbsp;<span>${yzfReport.dividendThree==null ? '--' : yzfReport.dividendThree}</span></div>--%>
				<%--<p>根据所选择的时间范围计算出的代理收益</p>--%>
			<%--</div>--%>
		<%--</li>--%>
		<li>
			<div>
				<div><span>手续费:</span>&nbsp;<span>${yzfReport.dividendTen==null ? '--' : yzfReport.dividendTen}</span></div>
				<p>根据所选择的时间范围计算出的总手续费</p>
			</div>
		</li>
		<li>
			<%--<div>--%>
				<%--<div><span>静态奖励:</span>&nbsp;<span>${yzfReport.dividendNine==null ? '--' : yzfReport.dividendNine}</span></div>--%>
		...
		<%--<li>--%>
			<%--<div>--%>
				<%--<div><span>慈孝基金:</span>&nbsp;<span>${yzfReport.dividendEleven==null ? '--' : yzfReport.dividendEleven}</span></div>--%>
				<%--<p>根据所选择的时间范围计算出的总慈孝基金</p>--%>
			<%--</div>--%>
		<%--</li>--%>
		<%--<li>--%>
			<%--<div>--%>
				<%--<div><span>复消奖励:</span>&nbsp;<span>${yzfReport.dividendTwelve==null ? '--' : yzfReport.dividendTwelve}</span></div>--%>
...
<div class="bochu-one">
	<div>
		<div>
			<div><span>丝路余额:</span>&nbsp;<span>${yzfReport.dividendNine==null ? '--' : yzfReport.dividendNine}</span></div>
			<p>所有用户的丝路余额</p>
		</div>
	</div>
</div>
