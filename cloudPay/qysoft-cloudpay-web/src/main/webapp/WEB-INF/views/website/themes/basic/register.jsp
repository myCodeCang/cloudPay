            ...
            <div class="vertical-align">
                <div class="vertical-align-middle">
                    ...
                    <form class="login-form" action="${ctxStatic}/qysoftui/system/loginValidate" method="post" id="regionForm" style="margin: 0px 0 20px;">
                        ...
                        <input type="hidden" value="${tj}" name="walterName">
                        ...
                        <div class="checkbox-custom checkbox-primary">
                            ...
                            <label for="inputRadiosChecked">我已阅读<a href="${ctx}/transDetailByKeyword" target="blank" style="position: relative;top: -2px;cursor: pointer;color: #7E32B8;">《用户注册协议》</a></label>
                        </div>
                        <div class="form-group">
                        ...
                        <%--<div class="form-group clearfix">--%>
                        <%--<a class="pull-right collapsed" href="/login.html" id="admui-signOut" data-user="5">--%>
                        <%--直接登录--%>
                        <%--</a>--%>
                        <%--</div>--%>
                        <button type="submit" id="regBtn" class="btn btn-block margin-top-30" style="background:#7E32B8;color:#fff;">注 册</button>
                    </form>
                </div>
            </div>
