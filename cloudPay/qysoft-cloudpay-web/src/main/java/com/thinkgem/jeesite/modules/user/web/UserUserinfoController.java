...
public class UserUserinfoController extends BaseController {
    ...
    public String list(UserUserinfo userUserinfo, HttpServletRequest request, HttpServletResponse response, Model model) {
        if(StringUtils2.isNotBlank(request.getParameter("isUsercenter"))){
            ...
            Page<UserUserinfo> page = userUserinfoService.findPage(new Page<UserUserinfo>(request, response), userUserinfo);
            List<UserUserinfo> pages = page.getList();
            for (UserUserinfo userinfo: pages) {
                userinfo.setAddressArea(areaService.getAreaById(userinfo.getAreaId(),new StringBuilder()).toString());
                Area area = areaDao.get(userinfo.getMainPerformance().toString());
    ...
    @RequestMapping(value = "userProxyManageForm")
    public String userProxyManageForm(HttpServletRequest request, HttpServletResponse response, Model model) throws ValidationException {

        return "modules/user/userProxyManageForm";
    }
     ...
     */
    @RequestMapping(value = "updateUserProxyManage")
    public String updateUserProxyManage(HttpServletRequest request, HttpServletResponse response,RedirectAttributes redirectAttributes) throws ValidationException {
        String userName = request.getParameter("userName");
        String mainPerformance = request.getParameter("mainPerformance");
        userUserinfoDao.updateIsProxy(userName,EnumUtil.YesNO.YES.toString(),mainPerformance,"3");
        addMessage(redirectAttributes, "开通代理成功!");
        return "redirect:" + Global.getAdminPath() + "/user/userUserinfo/userProxyManageForm";
    }

    @RequestMapping(value = "userShopManageForm")
    public String userShopManageForm(HttpServletRequest request, HttpServletResponse response, Model model) throws ValidationException {
        return "modules/user/userShopManageForm";
    }
     ...
     * @throws ValidationException
     */
    @RequestMapping(value = "updateUserShopManage")
    public String updateUserShopManage(HttpServletRequest request, HttpServletResponse response,RedirectAttributes redirectAttributes) throws ValidationException {
        String userName = request.getParameter("userName");
        userUserinfoDao.updateIsShop(userName,"1");
        addMessage(redirectAttributes, "开通商家成功!");
        return "redirect:" + Global.getAdminPath() + "/user/userUserinfo/userShopManageForm";
    }
